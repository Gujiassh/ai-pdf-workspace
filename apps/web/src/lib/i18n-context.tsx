...
export const translations = {
  zh: {
    ...
    "chat.emptyDesc": "AI 将结合当前工作区的文档内容回答，并提供可跳转的来源页码。",
    ...
    "workspace.knowledgeScope": "工作区知识库",
    "workspace.viewTabs": "工作区视图",
    "workspace.evidence": "查看原文",
    "workspace.pdfSource": "PDF 原文",
    "workspace.evidencePanel": "PDF 原文面板",
    "workspace.closeEvidence": "关闭证据面板",
    "workspace.openReader": "进入阅读模式",
    "workspace.exitReader": "退出阅读模式",
    "workspace.readyDocuments": "份就绪文档",
    "workspace.resizeEvidence": "调整 PDF 证据面板宽度",
    "chat.noteTitleTemplate": "引自《{doc}》第 {page} 页的笔记",
  ...
  en: {
    ...
    "chat.emptyDesc": "AI will use documents in this workspace and provide clickable source pages.",
    ...
    "sidebar.statusParsing": "Parsing Text",
    ...
    "sidebar.uploadTooltip": "Upload PDF",
    ...
    "sidebar.dropzone": "Drag & Drop or Click to Upload PDF",
    ...
    "workspace.knowledgeScope": "Workspace knowledge base",
    "workspace.viewTabs": "Workspace views",
    "workspace.evidence": "View source",
    "workspace.pdfSource": "PDF source",
    "workspace.evidencePanel": "PDF source panel",
    ...
    "workspace.resizeEvidence": "Resize PDF evidence panel",
    "chat.noteTitleTemplate": "Note cited from {doc} p.{page}",
