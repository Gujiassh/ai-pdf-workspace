          ...
          {msg.citations?.map((cit) => showNoteEditorId === cit.id && (
            ...
            >
              <div className="flex justify-between items-center pb-1 border-b border-zinc-200 dark:border-zinc-850">
                <span className="text-[10px] font-bold uppercase tracking-wider text-indigo-500 dark:text-indigo-400">智能划词沉淀</span>
                <button
              ...
              <div className="space-y-2">
                <div>
                  <label className="text-[9px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-wider block">标题</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="text-[9px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-wider block">内容</label>
                  <textarea
                    rows={4}
